...
# $FreeBSD: head/sys/boot/amd64/boot1.efi/generate-fat.sh 264993 2014-04-27 00:45:08Z nwhitehorn $
...
echo '# $FreeBSD: head/sys/boot/amd64/boot1.efi/generate-fat.sh 264993 2014-04-27 00:45:08Z nwhitehorn $' >> Makefile.fat
...
echo '$FreeBSD: head/sys/boot/amd64/boot1.efi/generate-fat.sh 264993 2014-04-27 00:45:08Z nwhitehorn $' >> $OUTPUT_FILE.bz2.uu
