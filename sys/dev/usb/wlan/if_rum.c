/*	$FreeBSD: head/sys/dev/usb/wlan/if_rum.c 260444 2014-01-08 08:06:56Z kevlo $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_rum.c 260444 2014-01-08 08:06:56Z kevlo $");
