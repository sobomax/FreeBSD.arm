/*	$FreeBSD: head/sys/dev/usb/wlan/if_rum.c 283540 2015-05-25 19:53:29Z glebius $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_rum.c 283540 2015-05-25 19:53:29Z glebius $");
