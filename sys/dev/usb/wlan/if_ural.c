/*	$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 292080 2015-12-11 05:28:00Z imp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 292080 2015-12-11 05:28:00Z imp $");
