/*	$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 269127 2014-07-26 16:06:01Z hselasky $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 269127 2014-07-26 16:06:01Z hselasky $");
