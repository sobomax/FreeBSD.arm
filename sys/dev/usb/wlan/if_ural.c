/*	$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 300749 2016-05-26 15:12:54Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: head/sys/dev/usb/wlan/if_ural.c 300749 2016-05-26 15:12:54Z avos $");
